...
import SpaceSideMenu from './_components/thread_side_menu';
import CreateCommentBox from './_components/create_comment_box';
import SpaceComments from './_components/thread_comments';
...
export default function ThreadByIdLayout({ children }: LayoutProps) {
