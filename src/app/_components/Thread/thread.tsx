  ...
  <div>
    ...
    {section.isOpen && (
      <div className="space-y-1 text-sm text-[#a1a1a1]">
        ...
        <Button
          variant="outline"
          className="text-[#a1a1a1] p-0 h-auto mt-1 text-sm hover:text-white"
        >
          View all →
        </Button>
      </div>
...
const ChatMessageComponent = ({
  ...
  <div className="space-y-2">
    <div className="flex items-center gap-2">
      ...
      {message.percentage && (
        <div className="ml-auto text-xs text-[#a1a1a1]">
          {message.percentage}%
        </div>
      )}
    </div>
      ...
      <div className="bg-[#262626] rounded-lg p-3 ml-8">
        <div className="flex items-center gap-2 mb-2">
          <Avatar className="w-4 h-4">
            <AvatarFallback className="bg-[#404040] text-xs">
              {message.replyTo.charAt(0).toUpperCase()}
            </AvatarFallback>
          </Avatar>
    ...
    {!message.isReply && (
      <div className="text-sm text-[#a1a1a1] leading-relaxed ml-8">
        {message.content}
      </div>
    )}
