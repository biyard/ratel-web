...
import { Send } from 'lucide-react'; // Optional icon for send button
...
//             width={34}
//             height={34}
//             className="[&>path]:stroke-neutral-500 md:mr-4"
//           />
...
function CommentInfo({ comment }: { comment: SpaceComment }) {
  ...
  const [likeCount, setLikeCount] = useState(0); // Default 0, or use comment.like_count if available
      ...
      <div className="flex flex-col mx-10 gap-3">
        ...
        <div className="flex flex-row  items-center gap-4">
          ...
          <div className="flex flex-row">
            <p className="text-primary">201 Reply</p>
            <Image
